...
# 除了pyg原生的GCN，论文使用自创图注意力机制的层和NTN层都在layers.py手动实现
...
class TenorNetworkModule(torch.nn.Module):
    ...
    def forward(self, embedding_1, embedding_2):
        ...
        # 结果也是K*1，然后加上偏置经过一层ReLU，就得到最终输出
